...
// Encoding : UTF-8
// Version  : 1.0
// (04/03/2022 09:11:11 - - $Rev: 24171 $)
// ************************************************************************ //

unit correios.service.interfaces;
...
type
  ...
  ErroMontagemRelatorio = class;                { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblCplx] }
  ...
  ErroMontagemRelatorio2 = class;               { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Flt][GblElm] }
  ...
  arg0                 = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Alias] }
  ...
  // Namespace : http://cliente.bean.master.sigep.bsb.correios.com.br/
  // ************************************************************************ //
  ErroMontagemRelatorio = class(TRemotable)
  private
    Fmessage_: string;
    Fmessage__Specified: boolean;
    procedure Setmessage_(Index: Integer; const Astring: string);
  ...
  // ************************************************************************ //
  ErroMontagemRelatorio2 = class(ERemotableException)
  private
    Fmessage_: string;
    Fmessage__Specified: boolean;
    procedure Setmessage_(Index: Integer; const Astring: string);
  ...
  // Namespace : http://cliente.bean.master.sigep.bsb.correios.com.br/
  // ************************************************************************ //
  return = class(servicoAdicionalXML)
  private
  published
  end;
  ...
  // Namespace : http://cliente.bean.master.sigep.bsb.correios.com.br/
  // ************************************************************************ //
  return2 = class(embalagemLRSMaster)
  private
  published
  end;
  ...
  // Namespace : http://cliente.bean.master.sigep.bsb.correios.com.br/
  // ************************************************************************ //
  return3 = class(servicoAdicionalTO)
  private
  published
  end;
  ...
  private
    ...
    procedure Setdescricao(Index: Integer; const Astring: string);
    function  descricao_Specified(Index: Integer): boolean;
    procedure Setdocumento(Index: Integer; const AArray_Of_string: Array_Of_string);
  ...
  published
    ...
    property descricao:       string            Index (IS_OPTN or IS_UNQL) read Fdescricao write Setdescricao stored descricao_Specified;
    property documento:       Array_Of_string   Index (IS_OPTN or IS_UNBD or IS_NLBL or IS_UNQL) read Fdocumento write Setdocumento stored documento_Specified;
  ...
  Array_Of_servicoAdicionalXML = array of servicoAdicionalXML;   { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  ...
  Array_Of_tipoEmbalagem = array of tipoEmbalagem;   { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  Array_Of_servicoAdicionalTO = array of servicoAdicionalTO;   { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  ...
  ['{06395354-FEDE-FDC9-368D-51C37A49D0E0}']
    function  buscaServicosAdicionaisAtivos(const usuario: string; const senha: string): Array_Of_servicoAdicionalXML; stdcall;
    ...
    function  VerificaSeTodosObjetosCancelados(const arg0: Array_Of_objetoPostal): Boolean; stdcall;
    ...
    function  buscaServicosValorDeclarado(const usuario: string; const senha: string): Array_Of_string; stdcall;
    ...
    function  pesquisarEmbalagensPorServico(const codigo: string): Array_Of_tipoEmbalagem; stdcall;
    ...
    function  pesquisarServicosAdicionais(const codigo: string): Array_Of_servicoAdicionalTO; stdcall;
    function  buscaServicosXServicosAdicionais(const usuario: string; const senha: string): Array_Of_string; stdcall;
    ...
    function  buscaOpcoes(const listaObjetos: Array_Of_string; const tipoResultado: string; const usuario: string; const senha: string): string; stdcall;
  end;
...
begin
  ...
  SysUtils.FreeAndNil(FdataBloqueioObjeto);
...
begin
  SysUtils.FreeAndNil(Faltura);
  SysUtils.FreeAndNil(Fcomprimento);
  SysUtils.FreeAndNil(Fdiametro);
  SysUtils.FreeAndNil(Flargura);
  SysUtils.FreeAndNil(Fpeso);
  SysUtils.FreeAndNil(Fsoma);
  inherited Destroy;
end;
...
begin
  SysUtils.FreeAndNil(Fmaximo);
  SysUtils.FreeAndNil(Fminimo);
  inherited Destroy;
end;
...
begin
  SysUtils.FreeAndNil(FvapDhTransacao);
  inherited Destroy;
end;
...
procedure coleta.Setdocumento(Index: Integer; const AArray_Of_string: Array_Of_string);
begin
  Fdocumento := AArray_Of_string;
...
initialization
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(ErroMontagemRelatorio), 'message_', 'message');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(ErroMontagemRelatorio2), 'message_', 'message');
  ...
  RemClassRegistry.RegisterXSClass(arg0, 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'arg0');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_servicoAdicionalXML), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_servicoAdicionalXML');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_servicoAdicionalXML), [xoInlineArrays]);
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_tipoEmbalagem), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_tipoEmbalagem');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_tipoEmbalagem), [xoInlineArrays]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_servicoAdicionalTO), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_servicoAdicionalTO');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_servicoAdicionalTO), [xoInlineArrays]);
